...
// Title
const InvertedStyledTitle = styled.Text `
  font-size: 28px;
  font-weight: 400;
  color: ${({ theme }) => {
...
// Heading1
const InvertedStyledHeading1 = styled.Text `
  font-size: 22px;
  font-weight: 400;
  color: ${({ theme }) => {
    if (isEmptyObject(theme)) {
...
// Heading2
const InvertedStyledHeading2 = styled.Text `
  font-size: 17px;
  font-weight: 400;
  color: ${({ theme }) => {
    if (isEmptyObject(theme)) {
...
// Heading3
const InvertedStyledHeading3 = styled.Text `
  font-size: 16px;
  font-weight: 400;
  color: ${({ theme }) => {
    if (isEmptyObject(theme)) {
...
// Body1
const InvertedStyledBody1 = styled.Text `
  font-size: 16px;
  color: ${({ theme }) => {
    if (isEmptyObject(theme)) {
        return light.text.contrast;
...
// Body2
const InvertedStyledBody2 = styled.Text `
  font-size: 14px;
  color: ${({ theme }) => {
    if (isEmptyObject(theme)) {
        return light.text.contrast;
